...
namespace SEDC.Adv.TryBeingFit.App
{
    class Program
    {
		...
		public static UserService<StandardUser> _standardUserSrvc = 
		...
		public static TrainingService<VideoTraining> _videoTrainingSrvc = 
			new TrainingService<VideoTraining>();
		public static TrainingService<LiveTraining> _liveTrainingSrvc =
			new TrainingService<LiveTraining>();
			...
			while (true)
			{
				...
				switch (mainMenuItem)
				{
					case "Train":
						...
						if (trainChoice == 2)
						{
							int trainingItem = _uiService.TrainMenuItems(_videoTrainingSrvc.GetTrainings());
						...
						if (trainChoice == 1)
						{
							int trainingItem = _uiService.TrainMenuItems(_liveTrainingSrvc.GetTrainings());
					...
					case "Reschedule training":
						...
						else
						{
							...
							Console.WriteLine("How many days do you want to reshedule the training");
