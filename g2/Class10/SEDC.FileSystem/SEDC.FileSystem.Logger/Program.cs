using SEDC.FileSystem.Logger.Entities;
using System;
using System.Collections.Generic;
using System.Linq;

namespace SEDC.FileSystem.Logger
{
    class Program
    {
        ...
        static List<User> users = new List<User>()
        {
            ...
            new User(){Username = "Gregonator", Password = "astalavista", Age = 20, Id = 76 }
        };
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                new User() { Username = "Gregonator", Password = "astalavista", Age = -2, Id = 76 };
