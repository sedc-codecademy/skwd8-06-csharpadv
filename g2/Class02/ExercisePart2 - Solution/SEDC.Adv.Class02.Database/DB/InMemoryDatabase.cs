...
namespace SEDC.Adv.Class02.Database.DB
{
    public class InMemoryDatabase
    {
        ...
        public InMemoryDatabase()
        {
            Users = new List<User>
            {
                new User() { Username = "martin", Password = "123", FullName = "Martin Panovski", IsTeacher = true },
                new User() { Username = "dejan", Password = "123", FullName = "Dejan Jovanov", IsTeacher = true },
